        ...
        <div class="row gx-4">
          <div class="col-xl-4 col-md-6">
            <div class="blog-block wow fadeInUp" data-wow-delay="200ms">
              ...
              <div class="content"> <div class="h4 entry-title"><a href="{{ route('award-details') }}">Indian CSR Award</a></div>
          ...
          <div class="col-xl-4 col-md-6">
            <div class="blog-block wow fadeInUp" data-wow-delay="400ms">
              ...
              <div class="content"> <div class="h4 entry-title"><a href="{{ route('award-details') }}">National Health Care Award</a></div>
          ...
          <div class="col-xl-4 col-md-6">
            <div class="blog-block wow fadeInUp" data-wow-delay="600ms">
              ...
              <div class="content"> <div class="h4 entry-title"><a href="{{ route('award-details') }}">International Award Summit 2025</a></div>
